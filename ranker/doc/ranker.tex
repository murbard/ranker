...
$$\log\left(1 + e^{-z}\right) \simeq \int_{\zeta=0}^{z} \left(\frac{1}{2} - \frac{1}{2} \text{erf}\left(\frac{\sqrt{\pi}}{4} z\right)\right) d\zeta = 
\frac{2}{\pi}\left(1-e^{-\frac{\pi z^2}{16}}\right) + \frac{1}{2} z~\mathrm{erfc}\left(\frac{\sqrt{\pi}}{4} z\right)$$
