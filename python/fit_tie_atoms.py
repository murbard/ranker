...
# standalone; if the basis parameterization changes there (or in models.basis_phi / cavi, or in
# CC/ranker.cc's bump_eval / basis_phi), update here too, or the validation below silently checks
# the wrong closed form.
